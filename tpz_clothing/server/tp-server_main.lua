...
AddEventHandler("tpz_clothing:save", function(outfitName, skinComp)
...
AddEventHandler("tpz_clothing:rename", function(outfitId, inputTitle)
...
AddEventHandler("tpz_clothing:delete", function(outfitId)
